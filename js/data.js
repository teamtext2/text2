...
const appData = [
  ...
  { id: 14, name: "Create Img", description: "Create images (in development).", icon: "https://text2.click/app/create-img/apple-touch-icon.png", url: "https://text2.click/app/create-img/" },
];
...
const navigationData = [
  ...
  },
  {
    ...
    dataLink: "https://team.text2.click",
    icon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
