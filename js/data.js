...
const socialMediaData = [
  ...
  },
  {
    ...
    links: [
      { name: "Text2", url: "https://www.instagram.com/text02com" }
    ]
  },
  {
    platform: "youtube",
...
const navigationData = [
  ...
  {
    name: "SERVICES",
    url: "https://text02.com/services",
    dataLink: "https://text02.com/services",
    icon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:18px; height:18px;">
      <path d="M6 21v-2a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v2" />
      <circle cx="12" cy="7" r="4" />
      <path d="M4 11h16M8 15v2m8-2v2" />
    </svg>`
  },
  {
    name: "TEAM",
    url: "https://text02.com/team",
    dataLink: "https://text02.com/team",
    icon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:18px;height:18px;">
